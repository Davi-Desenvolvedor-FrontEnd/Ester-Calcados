...
export default function () {
  ...
  return (
    <div className="h-full w-full min-w-[30%] flex flex-col items-center justify-center">
      ...
      {/* Formulário */}
      <form className="bg-linear-to-br from-purple-50 to-purple-100 rounded-2xl shadow-xl p-8 border border-purple-200 md:max-w-full md:mx-4 w-1/3">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              type="password"
              placeholder={
                type === "Login" ? "Digite sua senha" : "Crie uma senha segura"
              }
              className="w-full px-4 py-3 bg-white/80 border border-purple-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all placeholder:text-gray-400"
              required
            />
